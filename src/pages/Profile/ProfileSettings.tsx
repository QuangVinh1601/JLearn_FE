  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <div
          className="rounded-3xl shadow-xl p-6 md:p-8 animate-pulse"
        ...
        >
          <div className="text-center py-8">
            <p className="text-xl text-red-600">
              Lỗi tải thông tin người dùng: {userInfoError}
            </p>
            <p className="text-sm text-gray-500 mt-2">
              Vui lòng thử lại sau hoặc kiểm tra kết nối của bạn.
            </p>
            <button
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-4">
          <button
            className="w-full text-left px-4 py-3 rounded-lg hover:shadow-md transition-colors"
            ...
            >
              <div>
                ...
                <p className="text-sm text-gray-600">
                  ...
                  {key === "studyReminders" &&
                    "Nhận nhắc nhở để duy trì thói quen học"}
                  {key === "courseUpdates" &&
                    "Nhận thông báo về nội dung khóa học mới"}
                  {key === "achievements" &&
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Cho phép người khác xem các thành tích của bạn
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
        ...
        <div className="space-y-6">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleSettingChange("learning", "language", e.target.value)
              }
              className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none"
              style={{ borderColor: "#D4B896", backgroundColor: "#F0D5A8" }}
            >
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Tự động chuyển sang video tiếp theo khi hoàn thành
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleSettingChange("learning", "autoPlay", e.target.checked)
                }
                className="sr-only peer"
              />
              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-red-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-red-600"></div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Luôn hiển thị phụ đề khi xem video
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleSettingChange("learning", "subtitles", e.target.checked)
                }
                className="sr-only peer"
              />
              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-red-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-red-600"></div>
      ...
      {/* Danger Zone */}
      <div
        className="rounded-3xl shadow-xl p-6 md:p-8 border border-red-200"
        style={{ backgroundColor: "#F5E6CA" }}
      >
