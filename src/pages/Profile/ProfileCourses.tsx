...
const ProfileCourses: React.FC = () => {
  ...
  const SkeletonCard: React.FC = () => (
    <div
      ...
      style={{ backgroundColor: "#F0D5A8", borderColor: "#D4B896" }}
    >
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">
              Quản lý và truy cập vào các khóa học đã mua
            </p>
          </div>
                      ...
                      <div className="grid grid-cols-3 gap-3 mb-4">
                        {[
                          ...
                          },
                          {
                            ...
                            label: "Bài nghe",
                            value: content.listening,
                            color: "green",
                          },
                          {
                            icon: FaPencilAlt({ className: "text-red-400" }),
                            label: "Bài tập",
                            value: content.exercise,
                            color: "red",
                          },
                        ].map((item) => (
                          <div
                      ...
                      <div className="mb-5">
                        ...
                        <div className="space-y-1.5">
                          {content.lessons.slice(0, 3).map((lesson, idx) => (
                            <div
                              key={idx}
                              className="text-sm text-gray-700 flex items-center group-hover:text-red-700 transition-colors"
                            >
                              {FaArrowRight({
                                className:
                                  "w-3 h-3 text-red-400 group-hover:text-red-600 rounded-full mr-2.5 transition-colors",
                              })}
                              {lesson}
                            </div>
                          ))}
