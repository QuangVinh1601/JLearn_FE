    ...
    "n5-r1": {
        ...
        questions: [
            ...
            },
            {
                ...
                options: ["わたしはリンです。", "あなたはリンです。", "わたしはがっこうです。", "ともだちはリンです。"],
            },
        ],
    },
    "n5-r2": {
        ...
        questions: [
            ...
            },
            {
                ...
                options: ["はははやさしいです。", "ちちはせんせいです。", "あにはがくせいです。", "いもうとはかわいいです。"],
            },
        ],
    },
    "n5-r3": {
        ...
        questions: [
            {
                ...
                options: ["Bây giờ là mấy giờ?", "Bạn tên là gì?", "Bạn bao nhiêu tuổi?", "Bạn làm nghề gì?"],
            },
            {
    ...
    "n5-r5": {
        ...
        questions: [
            ...
            },
            {
                ...
                options: ["Cho tôi quyển sách này", "Tôi muốn mua cái này", "Tôi muốn ăn cái này", "Tôi muốn đi đâu"],
            },
        ],
    },
    "n5-l1": {
        ...
        questions: [
            ...
            },
            {
                ...
                options: ["Tôi là người Việt Nam", "Tôi là học sinh", "Tôi là giáo viên", "Tôi là người Nhật"],
            },
        ],
    },
    "n5-l2": {
        ...
        questions: [
            ...
            },
            {
                ...
                options: ["Mẹ là nội trợ", "Bố là bác sĩ", "Anh là học sinh", "Em là sinh viên"],
            },
        ],
    },
    "n5-l3": {
        ...
        questions: [
            {
                ...
                options: ["Cho tôi cái này", "Tôi muốn đi", "Tôi muốn ăn", "Tôi muốn học"],
            },
            {
        ...
        questions: [
            {
                ...
                options: ["Chào buổi trưa", "Chào buổi sáng", "Chào buổi tối", "Chúc ngủ ngon"],
            },
            {
...
const ExercisePage: React.FC = () => {
    ...
    const [userAnswers, setUserAnswers] = useState<(number | null)[]>(exercise ? Array(exercise.questions.length).fill(null) : []);
                                ...
                                <li key={idx}>
                                    <label className="flex items-center space-x-2">
                                        ...
                                        >
                                            ...
                                            {submitted && userAnswers[index] === idx && userAnswers[index] !== answers?.[index] && (
