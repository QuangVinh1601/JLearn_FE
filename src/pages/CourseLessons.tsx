...
const allLessonsData: Record<string, Lesson[]> = {
    ...
    "N4": [
        { id: 'n4-r1', title: 'Bài đọc hiểu N4 - Email công việc', type: 'reading' },
        { id: 'n4-r2', title: 'Bài đọc hiểu N4 - Thông báo', type: 'reading' },
        { id: 'n4-l1', title: 'Bài nghe hiểu N4 - Cuộc trò chuyện điện thoại', type: 'listening' },
        { id: 'n4-l2', title: 'Bài nghe hiểu N4 - Tin tức ngắn', type: 'listening' },
    ],
    "N3": [
        { id: 'n3-r1', title: 'Bài đọc hiểu N3 - Bài báo ngắn', type: 'reading' },
        { id: 'n3-r2', title: 'Bài đọc hiểu N3 - Hướng dẫn sử dụng', type: 'reading' },
        { id: 'n3-l1', title: 'Bài nghe hiểu N3 - Phỏng vấn', type: 'listening' },
        { id: 'n3-l2', title: 'Bài nghe hiểu N3 - Bài giảng ngắn', type: 'listening' },
    ],
        ...
        return (
            <div className="min-h-screen bg-gray-100 p-8 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-700 mb-6">
                    Bạn chưa mua khóa học cấp độ <span className="font-semibold">{level}</span>.
                </p>
                <button
